...
export class CreatePaymentsTable1780168998298 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "description" character varying NOT NULL, "amount" numeric(12,2) NOT NULL, "debt" numeric(12,2) NOT NULL, "remaining" numeric(12,2) NOT NULL, "method" "public"."payments_method_enum" NOT NULL, "expenses" jsonb NOT NULL, "group_id" uuid, "user_id" uuid, "payer_id" uuid, CONSTRAINT "PK_197ab7af18c93fbb0c9b28b4a59" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
